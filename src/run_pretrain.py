...
def read_data(args, tokenizer: BertTokenizer) -> dict:
    train_fine_path = os.path.join(args.pretrain_data_path, 'train_fine.txt')
    train_coarse_path = os.path.join(args.pretrain_data_path, 'train_coarse.txt')
...
def main():
    ...
    parser.add_argument('--num_epochs', type=int, default=10)  # 100
